    ...
    return function b(a, c, d) {
            ...
            var h = a(3)
                ...
                return g(b, a),
                    b.prototype.createEl = function() {
                        ...
                        "button" !== a && (m["default"].warn("Creating a Button with an HTML element of " + a + " is deprecated; use ClickableComponent instead."),
                            b = (0,
                                n.assign)({
                                tabIndex: 0
                            }, b),
            ...
            var g = a(95)
                ...
                function a(b, c, d) {
                    if (f(this, a),
                            ...
                            this.options_ = (0,
                                v["default"])({}, this.options_),
                            c = this.options_ = (0,
                                v["default"])(this.options_, c),
                ...
                return a.prototype.dispose = function() {
                    ...
                    a.prototype.initChildren = function() {
                        ...
                        if (c) {
                            ...
                            f = Array.isArray(c) ? c : Object.keys(c),
                                f.concat(Object.keys(this.options_).filter(function(a) {
                                    ...
                                    var c = a.getComponent(b.opts.componentClass || (0,
                                        t["default"])(b.name));
                                    return c && !g.isTech(c)
                                }).forEach(e)
                        }
                    ...
                    a.prototype.dimension = function(a, b, c) {
                        if (void 0 !== b)
                            return null !== b && b === b || (b = 0),
                                ("" + b).indexOf("%") !== -1 || ("" + b).indexOf("px") !== -1 ? this.el_.style[a] = b : this.el_.style[a] = "auto" === b ? "" : b + "px",
                    ...
                    a.prototype.emitTapEvents = function() {
                        ...
                        this.on("touchleave", d),
                            ...
                            this.on("touchend", function(d) {
                                if (b = null,
                                    c === !0) {
                                    (new Date).getTime() - a < 200 && (d.preventDefault(),
                                        this.trigger("tap"))
                                }
                            })
                    }
                    ...
                    a.getComponent = function(b) {
                        if (b)
                            return b = (0,
                                t["default"])(b),
                                a.components_ && a.components_[b] ? a.components_[b] : h["default"] && h["default"].videojs && h["default"].videojs[b] ? (r["default"].warn("The " + b + " component was added to the videojs object when it should be registered using videojs.registerComponent(name, component)"),
                    ...
                    b.prototype.createMenu = function() {
                        ...
                        if (b)
                            for (var c = b.length - 1; c >= 0; c--)
                                a.addChild(new n["default"](this.player(),{
                                    rate: b[c] + "x"
                                }));
                        return a
                    }
                    ...
                    b.prototype.update = function(a) {
                        ...
                        for (var g = 0; g < b.length; g++) {
                            var h = b.start(g)
                                , i = b.end(g)
                                , j = e[g];
                            j || (j = this.el_.appendChild(l.createEl()),
                                e[g] = j),
                                j.style.left = f(h, d),
            ...
            var i = a(5)
                ...
                return h(b, a),
                    ...
                    b.prototype.update = function(a, b) {
                        var c = (0,
                            p["default"])(a, this.player_.duration());
                        if (this.el().style.left = b + "px",
                                this.el().setAttribute("data-current-time", c),
                                this.keepTooltipsInside) {
                            var d = this.clampPosition_(b)
                                , e = b - d + 1
                                , f = parseFloat((0,
                                r["default"])(this.tooltip, "width"))
                                , g = f / 2;
                    ...
                    b.prototype.clampPosition_ = function(a) {
                        if (!this.keepTooltipsInside)
                            return a;
                        var b = parseFloat((0,
                            r["default"])(this.player().el(), "width"))
                            , c = parseFloat((0,
                            r["default"])(this.tooltip, "width"))
                            , d = c / 2
                            , e = a;
                ...
                return h(b, a),
                    ...
                    b.prototype.updateProgress = function(a) {
                        if (this.updateAriaAttributes(this.el_),
                            ...
                            var b = parseFloat((0,
                                r["default"])(this.player().el(), "width"))
                                , c = parseFloat((0,
                                r["default"])(this.tooltipProgressBar.tooltip, "width"))
                    ...
                    b.prototype.updateAriaAttributes = function(a) {
                        ...
                        a.setAttribute("aria-valuenow", (100 * this.getPercent()).toFixed(2)),
                            a.setAttribute("aria-valuetext", (0,
                ...
                function b(c, d) {
                    ...
                    if (h && void 0 === h.onchange) {
                        ...
                        j.on(["tap", "click"], function() {
                            ...
                            l || (l = s["default"].createEvent("Event"),
                ...
                return h(b, a),
                    ...
                    b.prototype.updateContent = function(a) {
                        var b = this.player_.scrubbing() ? this.player_.getCache().currentTime : this.player_.currentTime()
                            ...
                            , d = (0,
                            n["default"])(b, this.player_.duration());
                        d !== this.formattedTime_ && (this.formattedTime_ = d,
                    ...
                    b.prototype.updateContent = function(a) {
                        if (this.player_.duration()) {
                            var b = this.localize("Remaining Time")
                                , c = (0,
                                n["default"])(this.player_.remainingTime());
        ...
        43: [function(a, b, c) {
            ...
            var e = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(a) {
                ...
                , i = function(a, b) {
                if ("function" != typeof b && null !== b)
                    throw new TypeError("Super expression must either be null or a function, not " + (void 0 === b ? "undefined" : e(b)));
                a.prototype = Object.create(b && b.prototype, {
                    constructor: {
                        value: a,
                        enumerable: !1,
                ...
                var b = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}
                    ...
                    , d = {};
                (0,
                    h.isObject)(b) ? ("function" == typeof b.init && (g["default"].warn("Constructor logic via init() is deprecated; please use constructor() instead."),
        ...
        46: [function(a, b, c) {
            ...
            function d(a) {
                ...
                "number" == typeof a ? this.code = a : "string" == typeof a ? this.message = a : (0,
                    e.isObject)(a) && ("number" == typeof a.code && (this.code = a.code),
                    (0,
                        e.assign)(this, a)),
                ...
                return g(b, a),
                    b.prototype.createEl = function(b, c, d) {
                        return this.nonIconControl = !0,
                            a.prototype.createEl.call(this, "li", (0,
                                l.assign)({
            ...
            var i = a(5)
                ...
                return h(b, a),
                    b.prototype.addItem = function(a) {
                        this.addChild(a),
                            a.on("click", n.bind(this, function(a) {
                                this.unlockShowing()
                            }))
                    }
                    ,
                    ...
                    b.prototype.focus = function() {
                        ...
                        b.length > 0 && (a < 0 ? a = 0 : a >= b.length && (a = b.length - 1),
                ...
                return h(b, a),
                    ...
                    b.prototype.open = function() {
                        if (!this.opened_) {
                            ...
                            this.options_.pauseOnOpen && this.wasPlaying_ && a.pause(),
                    ...
                    b.prototype.content = function(a) {
                        return void 0 !== a && (this.content_ = a),
                            this.content_
                    }
                    ,
                    b
        ...
        51: [function(a, b, c) {
            ...
            var Z = ["progress", "abort", "suspend", "emptied", "stalled", "loadedmetadata", "loadeddata", "timeupdate", "ratechange", "volumechange", "texttrackchange"]
                ...
                function b(c, d, e) {
                    ...
                    if (!j.options_ || !j.options_.techOrder || !j.options_.techOrder.length)
                    ...
                    return j.options_.playerOptions = l,
                        j.initChildren(),
                ...
                return h(b, a),
                    ...
                    b.prototype.createEl = function() {
                        ...
                        c = this.el_ = d ? b.parentNode : a.prototype.createEl.call(this, "div"),
                    ...
                    b.prototype.dimension = function(a, b) {
                        ...
                        if ("" === b)
                            ...
                            var d = parseFloat(b);
                            if (isNaN(d))
                                return z["default"].error('Improper value "' + b + '" supplied for for ' + a),
                                    this;
                            this[c] = d
                        }
                    ...
                    b.prototype.loadTech_ = function(a, b) {
                        ...
                        "Html5" !== a && this.tag && (U["default"].getTech("Html5").disposeMediaElement(this.tag),
                        ...
                        b.src === this.cache_.src && this.cache_.currentTime > 0 && (d.startTime = this.cache_.currentTime),
                    ...
                    b.prototype.handleTechReady_ = function() {
                        if (this.triggerReady(),
                            ...
                            try {
                                ...
                                (0,
                                    z["default"])("deleting tag.poster throws in some browsers", a)
                            }
                            this.play()
                        }
                    }
                    ...
                    b.prototype.techGet_ = function(a) {
                        if (this.tech_ && this.tech_.isReady_)
                            try {
                                ...
                                throw void 0 === this.tech_[a] ? (0,
                                    z["default"])("Video.js: " + a + " method not defined for " + this.techName_ + " playback technology.", b) : "TypeError" === b.name ? ((0,
                    ...
                    b.prototype.buffered = function c() {
                        ...
                        return c && c.length || (c = (0,
                            C.createTimeRange)(0, 0)),
                            c
                    }
                    ,
                    b.prototype.bufferedPercent = function() {
                        return (0,
                            D.bufferedPercent)(this.buffered(), this.duration())
                    }
                    ,
                    ...
                    b.prototype.requestFullscreen = function() {
                        ...
                        return this.isFullscreen(!0),
                            a.requestFullscreen ? (p.on(l["default"], a.fullscreenchange, t.bind(this, function b(c) {
                    ...
                    b.prototype.exitFullscreen = function() {
                        ...
                        return this.isFullscreen(!1),
                            a.requestFullscreen ? l["default"][a.exitFullscreen]() : this.tech_.supportsFullScreen() ? this.techCall_("exitFullScreen") : (this.exitFullWindow(),
                                this.trigger("fullscreenchange")),
                            this
                    }
                    ,
                    ...
                    b.prototype.canPlayType = function(a) {
                        for (var b = void 0, c = 0, d = this.options_.techOrder; c < d.length; c++) {
                            ...
                            if (f || (f = j["default"].getComponent(e)),
                                    f) {
                                if (f.isSupported() && (b = f.canPlayType(a)))
                                    return b
                            } else
                                z["default"].error('The "' + e + '" tech is undefined. Skipped browser support check for that tech.')
                        }
                        return ""
                    }
                    ,
                    ...
                    b.prototype.reset = function() {
                        return this.loadTech_((0,
                            B["default"])(this.options_.techOrder[0]), null),
                    ...
                    b.prototype.error = function(a) {
                        ...
                        this.errorDisplay && this.errorDisplay.close(),
                            this) : (this.error_ = new J["default"](a),
                            this.addClass("vjs-error"),
                            z["default"].error("(CODE:" + this.error_.code + " " + J["default"].errorTypes[this.error_.code] + ")", this.error_.message, this.error_),
                            this.trigger("error"),
                            this)
                    }
                    ,
                    ...
                    b.prototype.languages = function() {
                        return (0,
                            O["default"])(b.prototype.options_.languages, this.languages_)
                    }
                    ,
                    b.prototype.toJSON = function() {
                        var a = (0,
                            O["default"])(this.options_)
                            , b = a.tracks;
                        a.tracks = [];
                        for (var c = 0; c < b.length; c++) {
                            var d = b[c];
                    ...
                    b.getTagSettings = function(a) {
                        var b = {
                            ...
                            , d = c["data-setup"];
                        if (r.hasElClass(a, "vjs-fluid") && (c.fluid = !0),
                            null !== d) {
                            var e = (0,
                                L["default"])(d || "{}")
                                , f = e[0]
            ...
            $.prototype.options_ = {
                ...
                Z.forEach(function(a) {
                    $.prototype["handleTech" + (0,
                        B["default"])(a) + "_"] = function() {
        ...
        54: [function(a, b, c) {
            ...
            var i = a(5)
                ...
                return h(b, a),
                    b.prototype.addItem = function(a) {
                        this.addChild(a),
                            a.on("click", n.bind(this, function() {
                                this.unlockShowing()
                            }))
                    }
                    ,
            ...
            var i = a(3)
                ...
                return h(b, a),
                    ...
                    b.prototype.createEl = function() {
                        ...
                        return r.BACKGROUND_SIZE_SUPPORTED || (this.fallbackImg_ = p.createEl("img"),
            ...
            function d(a) {
                return a.streamingFormats = {
                    ...
                    a.streamToParts = function(a) {
                        ...
                        var c = a.search(/&(?!\w+=)/)
                            , d = void 0;
                        return c !== -1 ? d = c + 1 : (c = d = a.lastIndexOf("/") + 1,
                        0 === c && (c = d = a.length)),
        ...
        59: [function(a, b, c) {
            ...
            for (var k = a(62), l = e(k), m = a(81), n = d(m), o = a(92), p = d(o), q = a(90), r = a(58), s = e(r), t = a(5), u = e(t), v = a(95), w = e(v), x = a(88), y = w["default"].navigator, z = function(a) {
                ...
                return h(b, a),
                    ...
                    ,
                    b
            }(l["default"]), A = z.prototype, B = "rtmpConnection,rtmpStream,preload,defaultPlaybackRate,playbackRate,autoplay,loop,mediaGroup,controller,controls,volume,muted,defaultMuted".split(","), C = "networkState,readyState,initialTime,startOffsetTime,paused,ended,videoWidth,videoHeight".split(","), D = 0; D < B.length; D++)
                j(B[D]),
                    i(B[D]);
        ...
        60: [function(a, b, c) {
                ...
                function b(c, d) {
                    ...
                    if (f && (e.el_.currentSrc !== f.src || c.tag && 3 === c.tag.initNetworkState_) ? e.setSource(f) : e.handleLateInit_(e.el_),
                        ...
                        for (var k = e.el_.childNodes, l = k.length, m = []; l--; ) {
                            ...
                            i || e.el_.hasAttribute("crossorigin") || !r.isCrossOrigin(n.src) || (i = !0)) : m.push(n))
                        }
                        for (var o = 0; o < m.length; o++)
                            e.el_.removeChild(m[o])
                    }
                    return ["audio", "video"].forEach(function(a) {
                        ...
                        e["featuresNative" + d + "Tracks"] && b && b.addEventListener && (e["handle" + d + "TrackChange_"] = function(a) {
                            ...
                            ,
                            b.addEventListener("change", e["handle" + d + "TrackChange_"]),
                            b.addEventListener("addtrack", e["handle" + d + "TrackAdd_"]),
                            b.addEventListener("removetrack", e["handle" + d + "TrackRemove_"]),
                    ...
                    e.featuresNativeTextTracks && (i && v["default"].warn((0,
                        x["default"])(j)),
                        e.handleTextTrackChange_ = t.bind(e, e.handleTextTrackChange),
                        e.handleTextTrackAdd_ = t.bind(e, e.handleTextTrackAdd),
                        e.handleTextTrackRemove_ = t.bind(e, e.handleTextTrackRemove),
                ...
                return i(b, a),
                    ...
                    b.prototype.handleLateInit_ = function(a) {
                        if (0 !== a.networkState && 3 !== a.networkState) {
                            if (0 === a.readyState) {
                                ...
                                return this.on("loadedmetadata", d),
                    ...
                    b.prototype.setCurrentTime = function(a) {
                        try {
                            ...
                            (0,
                                v["default"])(b, "Video is not ready. (Video.js)")
                        }
                    }
                    ,
                    ...
                    b.prototype.removeRemoteTextTrack = function(b) {
                        if (a.prototype.removeRemoteTextTrack.call(this, b),
            ...
            J.isSupported = function() {
                ...
                J.canControlVolume = function() {
                    try {
                        ...
                        return J.TEST_VID.volume = a / 2 + .1,
                        a !== J.TEST_VID.volume
                    } catch (b) {
                        return !1
                    }
                ...
                J.canControlPlaybackRate = function() {
                    ...
                    try {
                        ...
                        return J.TEST_VID.playbackRate = a / 2 + .1,
                ...
                J.prototype.featuresNativeTextTracks = J.supportsNativeTextTracks(),
                J.prototype.featuresNativeVideoTracks = J.supportsNativeVideoTracks(),
            ...
            J.patchCanPlayType = function() {
                ...
                J.unpatchCanPlayType = function() {
                    ...
                    return J.TEST_VID.constructor.prototype.canPlayType = L,
                        a
                }
                ,
                J.patchCanPlayType(),
                ...
                J.nativeSourceHandler.canHandleSource = function(a, b) {
                    if (a.type)
                        return J.nativeSourceHandler.canPlayType(a.type);
                    if (a.src) {
        ...
        61: [function(a, b, c) {
            ...
            var h = a(5)
                ...
                function b(c, d, g) {
                    e(this, b);
                    var h = f(this, a.call(this, c, d, g));
                    if (d.playerOptions.sources && 0 !== d.playerOptions.sources.length)
                        ...
                        for (var j = 0, l = d.playerOptions.techOrder; j < l.length; j++) {
                            ...
                            if (n || (o = i["default"].getComponent(n)),
                                o && o.isSupported()) {
                                c.loadTech_(n);
                                break
                            }
            ...
            var j = a(5)
                ...
                return h(c, b),
                    ...
                    c.prototype.bufferedPercent = function() {
                        return (0,
                            E.bufferedPercent)(this.buffered(), this.duration_)
                    }
                    ,
                    ...
                    c.prototype.error = function(a) {
                        return void 0 !== a && (this.error_ = new G["default"](a),
                            this.trigger("error")),
                            this.error_
                    }
                    ,
                    ...
                    c.prototype.initTextTrackListeners = function() {
                        ...
                        b && (b.addEventListener("removetrack", a),
                            ...
                            this.on("dispose", A.bind(this, function() {
                        ...
                        if (!I["default"].WebVTT)
                            if (K["default"].body.contains(this.el())) {
                                ...
                                if (!this.options_["vtt.js"] && (0,
                                        L.isPlain)(c) && Object.keys(c).length > 0)
                                    return void this.trigger("vttjsloaded");
                                var d = K["default"].createElement("script");
                                d.src = this.options_["vtt.js"] || "https://vjs.zencdn.net/vttjs/0.12.3/vtt.min.js",
                                    d.onload = function() {
                        ...
                        if (b) {
                            ...
                            var f = function() {
                                ...
                                for (var a = 0; a < b.length; a++) {
                                    ...
                                    "showing" === c.mode && c.addEventListener("cuechange", f)
                                }
                            };
                            g(),
                    ...
                    c.prototype.textTracks = function() {
                        return this.textTracks_ = this.textTracks_ || new u["default"],
                            this.textTracks_
                    }
                    ,
                    c.prototype.remoteTextTracks = function() {
                        return this.remoteTextTracks_ = this.remoteTextTracks_ || new u["default"],
                ...
                M.withSourceHandlers = function(a) {
                    a.registerSourceHandler = function(b, c) {
                        ...
                        a.prototype.setSource = function(b) {
                            ...
                            c !== a.nativeSourceHandler && (this.currentSource_ = b,
                        ...
                        a.prototype.disposeSourceHandler = function() {
                            ...
                            this.sourceHandler_ && (this.off(this.el_, "loadstart", a.prototype.firstLoadStartListener_),
                                this.off(this.el_, "loadstart", a.prototype.successiveLoadStartListener_),
        ...
        67: [function(a, b, c) {
            ...
            var g = a(78)
                ...
                function a(b) {
                    ...
                    if (a.prototype.setCues_.call(c, b),
                            Object.defineProperty(c, "length", {
                                get: function() {
                                    return this.length_
                                }
                            ...
                            for (var e = c.length; e--; ) {
                                ...
                                if (f) {
                                    ...
                                    if (b.color && (g.firstChild.style.color = b.color),
                                        b.textOpacity && j(g.firstChild, "color", i(b.color || "#fff", b.textOpacity)),
                                        b.backgroundColor && (g.firstChild.style.backgroundColor = b.backgroundColor),
                                        b.backgroundOpacity && j(g.firstChild, "backgroundColor", i(b.backgroundColor || "#000", b.backgroundOpacity)),
        ...
        70: [function(a, b, c) {
            ...
            var i = a(74)
                ...
                return h(b, a),
                    b.prototype.addTrack_ = function(b) {
                        a.prototype.addTrack_.call(this, b),
                            b.addEventListener("modechange", l.bind(this, function() {
                                this.trigger("change")
                            }))
                    }
                    ,
        ...
        72: [function(a, b, c) {
            ...
            var i = a(67)
                ...
                c.oncue = function(a) {
                    ...
                    ,
                    c.parse(a),
                d.length > 0 && (q["default"].console && q["default"].console.groupCollapsed && q["default"].console.groupCollapsed("Text Track parsing errors for " + b.src),
                ...
                d && (c.cors = d),
                    (0,
                        v["default"])(c, l.bind(this, function(a, c, d) {
                        if (a)
                            return o["default"].error(a, c);
                        if (b.loaded_ = !0,
                ...
                function b() {
                    ...
                    return "disabled" !== i && n.tech_.ready(function() {
                        ...
                        Object.defineProperty(n, "mode", {
                            ...
                            set: function(a) {
                                var b = this;
                                m.TextTrackMode[a] && (i = a,
                                "showing" === i && this.tech_.ready(function() {
            ...
            var i = a(42)
                ...
                return h(b, a),
                    b.prototype.addTrack_ = function(a) {
                        ...
                        this.tracks_.indexOf(a) === -1 && (this.tracks_.push(a),
                            this.trigger({
                                track: a,
                                type: "addtrack"
                            }))
        ...
        81: [function(a, b, c) {
            ...
            function n() {
                ...
                return Object.getOwnPropertyNames(b).forEach(function(a) {
                    ...
                    a.indexOf("aria-") !== -1 || "role" === a || "type" === a ? (T["default"].warn((0,
                        V["default"])(L, a, c)),
                        e.setAttribute(a, c)) : "textContent" === a ? o(e, c) : e[a] = c
                }),
                    Object.getOwnPropertyNames(c).forEach(function(a) {
            ...
            function w(a, b, c) {
                var d = t(a, b);
                if ("function" == typeof c && (c = c(a, b)),
                    "boolean" != typeof c && (c = !d),
                    c !== d)
                    return c ? u(a, b) : v(a, b),
                        a
            }
            function x(a, b) {
        ...
        82: [function(a, b, c) {
            ...
            function h(a) {
                ...
                if (!a || !a.isPropagationStopped) {
                    ...
                    if (a.target || (a.target = a.srcElement || v["default"]),
                ...
                d.dispatcher || (d.disabled = !1,
                        d.dispatcher = function(b, c) {
                            if (!d.disabled) {
                                ...
                                if (e)
                                    for (var f = e.slice(0), g = 0, i = f.length; g < i && !b.isImmediatePropagationStopped(); g++)
                                        try {
                                            f[g].call(a, b, c)
                                        } catch (j) {
                                            r["default"].error(j)
        ...
        83: [function(a, b, c) {
            ...
            c.bind = function(a, b, c) {
                ...
                c.throttle = function(a, b) {
                    ...
                    return function() {
                        var d = Date.now();
                        d - c >= b && (a.apply(void 0, arguments),
                            c = d)
                    }
                }
        }
            ...
            var e = a(95)
                ...
                , j = c.logByType = function(a, b) {
                    ...
                    d && (c && (b = b.map(function(a) {
                        ...
                        d.apply ? d[Array.isArray(b) ? "apply" : "call"](f["default"].console, b) : d(b))
                }
            ;
            i = function() {
        ...
        87: [function(a, b, c) {
            "use strict";
            function d() {
                for (var a = {}, b = arguments.length, c = Array(b), f = 0; f < b; f++)
                    c[f] = arguments[f];
        ...
        88: [function(a, b, c) {
            ...
            function f(a) {
                for (var b = arguments.length, c = Array(b > 1 ? b - 1 : 0), e = 1; e < b; e++)
                    c[e - 1] = arguments[e];
        ...
        93: [function(b, c, d) {
            ...
            function g(a, b, c) {
                ...
                if ("string" == typeof a) {
                    if (0 === a.indexOf("#") && (a = a.slice(1)),
                            g.getPlayers()[a])
                        return b && O["default"].warn('Player "' + a + '" is already initialised. Options will not be applied.'),
                ...
                b = b || {},
                    g.hooks("beforesetup").forEach(function(a) {
                        var c = a(d, (0,
                            B["default"])(b));
                        if (!(0,
                                V.isObject)(c) || Array.isArray(c))
                            return void O["default"].error("please return an object in beforesetup hooks");
                        b = (0,
                            B["default"])(b, c)
                    });
            ...
            if ("undefined" == typeof HTMLVideoElement && Q.isReal() && (l["default"].createElement("video"),
                    ...
                    g.removeHook = function(a, b) {
                        ...
                        return !(c <= -1) && (g.hooks_[a] = g.hooks_[a].slice(),
            ...
            n.autoSetupTimeout(1, g),
                ...
                g.addLanguage = function(a, b) {
                    ...
                    return a = ("" + a).toLowerCase(),
                        g.options.languages = (0,
                            B["default"])(g.options.languages, (c = {},
                            c[a] = b,
                            c)),
        ...
        99: [function(a, b, c) {
            ...
            function h(a) {
                ...
                function c() {
                    var a = void 0;
                    if (a = k.response ? k.response : k.responseText || i(k),
                            u)
                        try {
                            a = JSON.parse(a)
                        } catch (b) {}
                ...
                if ("json"in a && a.json !== !1 && (u = !0,
                    ...
                    !t && a.timeout > 0 && (o = setTimeout(function() {
                        ...
                        k.setRequestHeader)
                    for (l in s)
                        s.hasOwnProperty(l) && k.setRequestHeader(l, s[l]);
        ...
        106: [function(a, b, c) {
            !function(a) {
                ...
                function l(a, b, c) {
                    ...
                    d || (h.direction = i(this.cueDiv),
                        h.writingMode = "" === b.vertical ? "horizontal-tb" : "lr" === b.vertical ? "vertical-lr" : "vertical-rl".stylesunicodeBidi = "plaintext"),
                        this.applyStyles(h),
                ...
                function n(a, b, c, d) {
                    ...
                    if (g.snapToLines) {
                        ...
                        var l = f.lineHeight
                            ...
                            , o = c[k] + l
                            , p = i[0];
                        Math.abs(n) > o && (n = n < 0 ? -1 : 1,
                            n *= Math.ceil(o / l) * l),
                        h < 0 && (n += "" === g.vertical ? c.height : c.width,
                            i = i.reverse()),
                            f.move(p, n)
                    } else {
                ...
                b.prototype = p(Error.prototype),
                    ...
                    d.prototype = {
                        ...
                        percent: function(a, b) {
                            return !!(b.match(/^([\d]{1,3})(\.[\d]*)?%$/) && (b = parseFloat(b),
                    ...
                    o.Parser.prototype = {
                        ...
                        parse: function(a) {
                            ...
                            function i(a) {
                                ...
                                k.ontimestampmap && k.ontimestampmap({
                                    MPEGTS: b.get("MPEGTS"),
                                    LOCAL: b.get("LOCAL")
                                })
                            }
                            ...
                            try {
                                ...
                                for (var n = !1; k.buffer; ) {
                                    ...
                                    switch (n ? n = !1 : l = g(),
                                        ...
                                        case "ID":
                                            ...
                                            if (!l)
                                                continue;
                                            if (k.cue = new (k.vttjs.VTTCue || k.window.VTTCue)(0,0,""),
                                                    k.state = "CUE",
                                                l.indexOf("-->") === -1) {
                                                k.cue.id = l;
                                                continue
                                ...
                                k.reportOrThrowError(o),
                                "CUETEXT" === k.state && k.cue && k.oncue && k.oncue(k.cue),
                                    k.cue = null,
                                    k.state = "INITIAL" === k.state ? "BADWEBVTT" : "BADCUE"
                            }
                            return this
                        },
                        flush: function() {
